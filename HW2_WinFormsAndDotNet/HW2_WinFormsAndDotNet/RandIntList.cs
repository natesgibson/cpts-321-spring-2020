...
namespace HW2_WinFormsAndDotNet
{
    ...
    public class RandIntList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RandIntList"/> class.
        /// </summary>
        public RandIntList()
        {
        }
        ...
        public RandIntList(int size, int lowerBound, int upperBound)
        {
            this.size = size;
